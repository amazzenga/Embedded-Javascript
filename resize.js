...
function tabletSize(){
  ...
  all[1].style.width = String(height*0.75)+"px";
}
...
function phoneSize(){
  ...
  all[0].style.width = String(width*0.5)+"px";
  all[0].style.height = String(height*0.5)+"px";
  all[1].style.width = String(width*0.5)+"px";
  all[1].style.width = String(height*0.5)+"px";
}
